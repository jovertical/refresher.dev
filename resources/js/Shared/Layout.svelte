    ...
    >
        <div class="fixed inset-0 flex z-40">
            ...
            <div
                ...
                use:clickOutside
                on:click_outside="{() => (sidebarOpen = false)}"
            >
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 px-2 space-y-1">
                        ...
                        >
                            <Icon class="text-gray-300 mr-4" name="home" />
                            <span>Dashboard</span>
                        </InertiaLink>
                        ...
                        >
                            <Icon
                                class="text-gray-400 group-hover:text-gray-300 mr-4"
                                name="beaker"
                            />
                            <span>Tests</span>
                        </InertiaLink>
            ...
            <div class="flex flex-col h-0 flex-1 bg-gray-800">
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 flex-1 px-2 bg-gray-800 space-y-1">
                        ...
                        >
                            <Icon class="text-gray-300 mr-3" name="home" />
                            <span>Dashboard</span>
                        </InertiaLink>
                        ...
                        >
                            <Icon
                                class="text-gray-400 group-hover:text-gray-300 mr-3"
                                name="beaker"
                            />
                            <span>Tests</span>
                        </InertiaLink>
